...
const stanzas = [
  ...
  },
  {
    ...
    b: 'دیر تسویه شدن، یک «ویژگیِ نباشد» نیست؛ یک شکست است. ما تسویه‌ی زیرِ یک ثانیه را به‌مثابه‌ی خدمت تعریف کرده‌ایم، نه ویژگیِ اضافه.',
  },
  {
    n: '۰۳',
...
const timeline = [
  {
    ...
    body:
      'اگر تسویه‌ی بازارِ سرمایه به‌جای T+۲ بشود T+۰، اقتصادِ صندوق‌ها چه شکلی می‌شود؟',
  },
  {
    year: '۱۴۰۱',
    title: 'اولین اتصالاتِ بانکی',
    body:
      'سه بانکِ اول. اولین تسویه‌ی آزمایشی در زیرِ ثانیه روی ریلِ بانکداریِ باز.',
  },
  {
    year: '۱۴۰۲',
        ...
        <Container className="relative py-24 sm:py-32">
          ...
          <Heading
            fa={
              <>
                پرداخت،<br />
                <span className="text-sky">آنی و تخصصی</span>
              </>
            }
            en="Payment — instant and specialist"
            level={1}
            tone="paper"
          ...
          <p className="mt-8 max-w-2xl text-[17.5px] leading-[1.85] text-paper/78">
            ...
            شده. ما تسویه‌ی T+۰ را روی بازاری ممکن کردیم که سال‌ها با چک، مهر و
